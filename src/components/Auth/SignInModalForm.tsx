          ...
          <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
            <div className='flex min-h-full items-center justify-center'>
              ...
              >
                ...
                <div className='mb-4 mt-4 flex justify-center p-6'>
                  <PrimaryButton
                    className='h-12 flex-1 rounded-md border border-black bg-white px-3 py-1.5 text-sm/6 font-semibold shadow-inner shadow-white/10 focus:outline-none'
                    onClick={handleClose}
                    variant='outlined'
                  >
                    <span className='flex justify-center text-base text-black'>
                      <img src='/images/png/google_icon.png' alt='Google' className='mr-2 h-6 w-6' /> Tiếp tục với
                      Google
                    </span>
                  </PrimaryButton>
                </div>
