    ...
    <form onSubmit={onSubmit} className='px-6'>
      <div className='flex h-[30rem] flex-col gap-4 overflow-hidden overflow-y-auto px-2'>
        ...
        <div className='flex items-center justify-center'>
          <PrimaryButton className='h-12 w-fit px-6 py-1.5 text-sm/6 font-semibold text-black shadow-inner shadow-white/10 focus:outline-none'>
            <p className={'text-base text-black'}>Đổi mật khẩu</p>
          </PrimaryButton>
        </div>
      </div>
    </form>
