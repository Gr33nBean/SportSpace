...
const Banner = () => {
  return (
    <section className='background-banner-home dark-overlay relative flex h-[calc(100vh-80px-85px)] min-h-[800px] flex-1 items-center justify-center px-6 py-8 md:px-24 lg:px-32'>
